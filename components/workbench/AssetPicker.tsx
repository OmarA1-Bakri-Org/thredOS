            ...
            return (
              <button
                ...
                className={`w-full border px-3 py-2.5 text-left transition-all ${
                  active
                    ...
                    : selected
                    ? 'border-emerald-500/25 bg-emerald-500/6 text-white'
              ...
              >
                ...
                <div className="mt-2 flex flex-wrap gap-1.5">
                  <span className="max-w-full truncate rounded-full border border-slate-700 bg-slate-950/70 px-2 py-0.5 font-mono text-[9px] uppercase tracking-[0.14em] text-slate-400">{item.path}</span>
