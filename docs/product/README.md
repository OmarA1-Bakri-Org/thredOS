...
This folder is the **repo-truth documentation set** for the product as it exists today.

Use it when you need to answer four questions quickly:

- what thredOS is
- what is actually implemented
- what is still partial or intentionally future-facing
- where the important architecture lives in the repo

## Ground Rules

- thredOS is the active product today.
...
- [Product Narrative](./product-narrative.md): the canonical vocabulary for thredOS, Thread Runner, threads, surfaces, runs, packs, and builders
